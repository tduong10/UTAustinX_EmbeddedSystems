...
// keys
// Period =  80000000/32/Freq=2500000/Freq		..from dac.pdf
...
#define G    3189   // 784 Hz			key 3
#define GF  3378   // 740 Hz
#define F   3579   // 698.5 Hz
#define E   3792   // 659.3 Hz		key 2
#define EF  4018   // 622.3 Hz
#define D   4257   // 587.3 Hz		key 1
#define DF  4510   // 554.4 Hz
#define C0  4778   // 523.3 Hz		key 0
...
// input from keys to select tone
		unsigned short pianoKeys = Piano_In();
		if (pianoKeys == 0x01)
		{
			Sound_Tone(C0);
		}
		else if (pianoKeys == 0x02)
		{
			Sound_Tone(D);
		}
		else if (pianoKeys == 0x04)
		{
			Sound_Tone(E);
		}
		else if (pianoKeys == 0x08)
		{
			Sound_Tone(G);
		}
		else
